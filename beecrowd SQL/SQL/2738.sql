...
-- contendo o nome do candidato e a sua pontuação final (com duas casas decimais após a vírgula). Lembre-se de mostrar
...
VALUES 
  ...
  --RESOLUÇÃO
SELECT candidate.name, round((score.math*2 + specific*3+project_plan*5)/10.0,2) as AVG
